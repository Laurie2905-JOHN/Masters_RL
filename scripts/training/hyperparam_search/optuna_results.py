...
journal_file_path = "saved_models/evaluation/optuna/A2C_parralel/journal_storage/journal.log"  # Replace with your actual journal log path
...
# Load the study
study_name = "A2C_parralel"  # Replace with your actual study name
