...
log_dir = os.path.abspath("saved_models/tensorboard/A2C_newEnv")
save_dir = os.path.abspath("saved_models/checkpoints/A2C_newEnv")
new_logger = configure(log_dir, ["stdout", "tensorboard"])

checkpoint_callback = CheckpointCallback(save_freq=10000, save_path=save_dir, name_prefix='A2C_newEnv')
...
model.save(os.path.join(save_dir, "A2C_newEnv"))
