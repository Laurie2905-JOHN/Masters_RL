...
class SimpleCalorieOnlyEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        scaled_action = np.zeros(self.n_ingredients)
        
        self.current_info = self._get_info(total_selection, average_calories_per_day, scaled_action, calories_selected_ingredients)
    ...
    def _get_info(self, total_selection, average_calories_per_day, scaled_action, calories_selected_ingredients):
    ...
    def render(self):
        if self.render_mode == 'human':
            if self.current_info:
                ...
                print(f"Scaled Action: {self.current_info.get('Scaled Action', 'N/A')}")
