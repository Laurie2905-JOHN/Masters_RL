...
if __name__ == "__main__":
    ...
    directory_list = ["saved_models/tensorboard", "saved_models/best_models", "saved_models/checkpoints", "saved_models/hpc_output", "saved_models/reward", "saved_models/hyperparams", "saved_models/losses", "scripts/preference/saved_data"]
