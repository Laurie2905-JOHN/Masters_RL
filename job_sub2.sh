...
python "/rds/general/user/lej23/home/fyp/Masters_RL/scripts/training/train.py" --algo A2C --env_name SchoolMealSelection-v0 --num_envs 4 --total_timesteps 100000 --save_freq 10000 --eval_freq 100
