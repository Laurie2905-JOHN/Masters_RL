...
python scripts/training/train.py --algo="A2C" --env_name="CalorieOnlyEnv-v3" --num_envs=3 --total_timesteps=2500000 --save_freq=10000 --eval_freq=1000 --device=cuda --seed=89 --num_people=50 --save_prefix="50_people" --log_prefix="50_people"
